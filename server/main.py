...
import os
import datetime
import server.handler.speech_handler as speech_handler  
import server.handler.audio_handler as audio_handler   
import server.handler.llm_handler as llm_handler
...
def get_edi_answer(user_text, emotion_rules_text=""):
    ...
    raw_response = llm_handler.get_edi_response(user_text + emotion_rules_text)
...
if __name__ == "__main__":
    # This is the "whiteboard" your API and Brain use to talk to each other
    shared_whiteboard = {
        "status": "idle",
        "message": "",
        "emotion": "NEUTRAL",
    ...
    try:
        # This turns the key and starts EDI
        run_edi_loop(shared_whiteboard)
    except KeyboardInterrupt:
        print("\nEDI System shutting down...")